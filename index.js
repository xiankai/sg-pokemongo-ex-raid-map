...
L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {
	attribution:
		'&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors | <a href="https://github.com/xiankai/sg-pokemongo-ex-raid-map/issues/new">Leave comments here</a>',
}).addTo(map);
...
fetchLocal(
	'https://cdn.rawgit.com/xiankai/fc4260e305d1339756a3e1a02b495939/raw/1898154f6ce324bbb7c9a66c15d22fc49880141b/all.geojson'
).then(data => {
	gyms = data;
	...
	if (e.target.value === 'all') {
		addToMap(
			L.geoJSON(gyms, {
				filter: feature =>
					feature.properties[key] &&
					feature.properties[key].length > -1,
			})
		);
	} else {
		addToMap(
